...
const Discount = () => {
  ...
  return (
    <div className="flex justify-center bg-gray-50">
      <div className="flex flex-col max-w-6xl w-full mt-12 sm:mt-16 px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row justify-between items-center mb-4 gap-4">
          ...
          <div className="text-red-500 font-bold text-base sm:text-lg bg-gray-200 px-3 py-1 rounded-lg">
            {formatTime(timeLeft)}
          </div>
        </div>
        <div className="mb-8">
        ...
        <div className="text-center mb-4">
          <button
            ...
            className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-4 sm:px-6 py-2 rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300"
          >
        ...
        {showAll && (
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
            {products.length > 0 ? (
              ...
              <p className="text-gray-500 text-center col-span-2 sm:col-span-3 md:col-span-4">
                Loading products...
              </p>
            )}
          </div>
